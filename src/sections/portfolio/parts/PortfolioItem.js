    ...
    render() {
        ...
        if (this.props.type === "slider") {
                ...
                <a href={this.props.link} target="_blank" rel="noopener noreferrer">
                    <Tilt options={{scale: 1, max: 10}}>
                        <Item className="blue-shadow">
                            ...
                            <DesktopContent text={this.props.text} category={this.props.category}
                                            ref={(cd) => this.child = cd} type={this.props.type}/>
                        </Item>
                    </Tilt>
                </a>
            )
            ...
            return (
                <a href={this.props.link} target="_blank" rel="noopener noreferrer">
                    <Tilt options={{scale: 1, max: 10}}>
                        <Item className={`${this.props.index % 2 === 0 ? "move-up" : "move-down"}`}
